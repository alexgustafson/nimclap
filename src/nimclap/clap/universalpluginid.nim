type UniversalPluginId* {.bycopy.} = object
  ## Pair of plugin ABI and plugin identifier.
  ##
  ## If you want to represent other formats please send us an update to the
  ## comment with the name of the abi and the representation of the id.
  abi*: cstring
