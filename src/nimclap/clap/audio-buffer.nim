...
type
  ClapAudioBufferT* {.bycopy.} = object
    data32*: ptr ptr cfloat      ##  Either data32 or data64 pointer will be set.
    data64*: ptr ptr cdouble
    channelCount*: uint32T
    latency*: uint32T          ##  latency from/to the audio interface
    constantMask*: uint64T
